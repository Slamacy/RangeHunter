...
function pitfall(ctx, xCenter, yCenter, height, width, canvasWidth, canvasHeight) {
    this.ctx = ctx;
...
pitfall.prototype.start = function() {
    this.animationIsDisplayed = true;
    this.animationInterval = setInterval(this.update.bind(this), this.animationSpeed);
};

pitfall.prototype.stop = function() {
    this.animationIsDisplayed = true;
    clearInterval(this.animationInterval);
    this.animationInterval = null;
};

pitfall.prototype.end = function() {
    this.stop();
    this.animationIsDisplayed = false;
};

pitfall.prototype.update = function(){
...
pitfall.prototype.render = function(){
